...
void TextRenderer::UpdateTexture()
{
    ...
    if (status != Ok)
    {
        OutputDebugStringA("[TextRenderer] Failed to load font file\n");
        return;
    }
    ...
    if (FAILED(hr))
    {
        OutputDebugStringA("[TextRenderer] Failed to create texture\n");
        return;
    }
    ...
    if (FAILED(hr))
    {
        OutputDebugStringA("[TextRenderer] Failed to create SRV\n");
    }
}

void TextRenderer::RenderUI()
{
